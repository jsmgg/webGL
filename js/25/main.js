    ...
    init : function() {
        ...
        Core.util.loadImages([
                ...
                var gl = Core.util.getgl( '#js_canvas' ),
                    ...
                    //box1 = Core.createCube( gl, shader2 ),
                    box2 = Core.createCube( gl, shader1 ),
                    box3 = Core.createCircle( gl, shader1),
                    box4 = Core.createCircle( gl, shader2);
                box1.childModules = [ box2, box3, box4]
                box1.perspective( self.fov , Core.util.pix, 0.0001, 100);
                //box1.lookAt(0,0,0);
                box2.translate(0.1, 0, -0.8);
                box2.scale( 0.1, 0.1, 0.1);
                box3.translate(-0.2, 0, -0.5);
                box3.scale( 0.1, 0.1, 0.1);
                box4.translate(0.3, 0.1, -0.6);
                box4.scale( 0.1, 0.1, 0.1 );
                self.object3d = box1;
                self.animate( gl );
                self.bindEvent( gl );
        });
